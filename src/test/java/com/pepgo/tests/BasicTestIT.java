...
*/
    ...
    public void googleCheeseExample() {
        ...
        System.out.println("Page title is: " + driver.getTitle());
        Assert.assertTrue(driver.getTitle().toLowerCase().contains("cheese"));
    }
    ...
    public void googleImagesExample() {
        ...
        System.out.println("Page title is: " + driver.getTitle());
        Assert.assertTrue(driver.getTitle().toLowerCase().contains("images"));
    }
    ...
    public void googleAirportExample(final String airportCode, final String airportName) {
        ...
        System.out.println("Page title is: " + driver.getTitle());
        Assert.assertTrue(driver.findElement(By.tagName("body")).getText().toLowerCase().contains(airportName.toLowerCase()));
    }
